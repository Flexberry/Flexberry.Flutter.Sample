...
import 'package:backend/src/model/collection_of_application_user.dart';
import 'package:backend/src/model/ember_flexberry_dummy_application_user.dart';
import 'package:backend/src/model/ember_flexberry_dummy_application_user_create.dart';
import 'package:backend/src/model/ember_flexberry_dummy_application_user_update.dart';
import 'package:backend/src/model/error.dart';
import 'package:backend/src/model/o_data_test_typed_result_post_request.dart';
import 'package:built_collection/built_collection.dart';

class EmberFlexberryDummyApplicationUsersApi {
  final Dio _dio;

  final Serializers _serializers;

  const EmberFlexberryDummyApplicationUsersApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [CollectionOfApplicationUser] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CollectionOfApplicationUser>>
    ...
    final _path = r'/EmberFlexberryDummyApplicationUsers';
    ...
    CollectionOfApplicationUser? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(CollectionOfApplicationUser),
            ) as CollectionOfApplicationUser;
    ...
    return Response<CollectionOfApplicationUser>(
      data: _responseData,
  ...
  ///
  /// Parameters:
  /// * [emberFlexberryDummyApplicationUserCreate] - New entity
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<EmberFlexberryDummyApplicationUser>>
    ...
    required EmberFlexberryDummyApplicationUserCreate
    ...
    try {
      const _type = FullType(EmberFlexberryDummyApplicationUserCreate);
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> emberFlexberryDummyApplicationUsersPrimaryKeyDelete({
    ...
    final _path = r'/EmberFlexberryDummyApplicationUsers({__PrimaryKey})'
        .replaceAll(
            '{' r'__PrimaryKey' '}',
  ...
  /// Parameters:
  /// * [primaryKey] - key: __PrimaryKey
  /// * [emberFlexberryDummyApplicationUserUpdate] - New property values
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> emberFlexberryDummyApplicationUsersPrimaryKeyPatch({
    required String primaryKey,
    required EmberFlexberryDummyApplicationUserUpdate
    ...
    try {
      const _type = FullType(EmberFlexberryDummyApplicationUserUpdate);
      _bodyData = _serializers.serialize(
          emberFlexberryDummyApplicationUserUpdate,
          specifiedType: _type);
    } catch (error, stackTrace) {
  ...
  Future<Response<EmberFlexberryDummyApplicationUser>>
    ...
    final _path =
        r'/EmberFlexberryDummyCommentVotes({__PrimaryKey})/ApplicationUser'
            .replaceAll(
                '{' r'__PrimaryKey' '}',
                encodeQueryParameter(
                        _serializers, primaryKey, const FullType(String))
  ...
  Future<Response<EmberFlexberryDummyApplicationUser>>
    ...
    final _path = r'/EmberFlexberryDummyVotes({__PrimaryKey})/Author'
        .replaceAll(
            '{' r'__PrimaryKey' '}',
            encodeQueryParameter(
                    _serializers, primaryKey, const FullType(String))
  ...
  ///
  /// Parameters:
  /// * [oDataTestTypedResultPostRequest] - Action parameters
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future] containing a [Response] with a [CollectionOfApplicationUser] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CollectionOfApplicationUser>> oDataTestTypedResultPost({
    ODataTestTypedResultPostRequest? oDataTestTypedResultPostRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/ODataTestTypedResult';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(ODataTestTypedResultPostRequest);
      _bodyData = oDataTestTypedResultPostRequest == null
          ? null
          : _serializers.serialize(oDataTestTypedResultPostRequest,
              specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
