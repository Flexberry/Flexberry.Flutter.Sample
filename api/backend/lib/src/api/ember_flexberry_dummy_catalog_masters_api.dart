...
import 'package:backend/src/model/collection_of_catalog_master.dart';
import 'package:backend/src/model/ember_flexberry_dummy_catalog_master.dart';
import 'package:backend/src/model/ember_flexberry_dummy_catalog_master_create.dart';
import 'package:backend/src/model/ember_flexberry_dummy_catalog_master_update.dart';
import 'package:backend/src/model/error.dart';
import 'package:built_collection/built_collection.dart';

class EmberFlexberryDummyCatalogMastersApi {
  final Dio _dio;

  final Serializers _serializers;

  const EmberFlexberryDummyCatalogMastersApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [CollectionOfCatalogMaster] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CollectionOfCatalogMaster>>
    ...
    final _path = r'/EmberFlexberryDummyCatalogMasters';
    ...
    CollectionOfCatalogMaster? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(CollectionOfCatalogMaster),
            ) as CollectionOfCatalogMaster;
    ...
    return Response<CollectionOfCatalogMaster>(
      data: _responseData,
  ...
  ///
  /// Parameters:
  /// * [emberFlexberryDummyCatalogMasterCreate] - New entity
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<EmberFlexberryDummyCatalogMaster>>
    ...
    required EmberFlexberryDummyCatalogMasterCreate
    ...
    try {
      const _type = FullType(EmberFlexberryDummyCatalogMasterCreate);
      _bodyData = _serializers.serialize(emberFlexberryDummyCatalogMasterCreate,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> emberFlexberryDummyCatalogMastersPrimaryKeyDelete({
    ...
    final _path = r'/EmberFlexberryDummyCatalogMasters({__PrimaryKey})'
        .replaceAll(
            '{' r'__PrimaryKey' '}',
  ...
  /// Parameters:
  /// * [primaryKey] - key: __PrimaryKey
  /// * [emberFlexberryDummyCatalogMasterUpdate] - New property values
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> emberFlexberryDummyCatalogMastersPrimaryKeyPatch({
    required String primaryKey,
    required EmberFlexberryDummyCatalogMasterUpdate
    ...
    try {
      const _type = FullType(EmberFlexberryDummyCatalogMasterUpdate);
      _bodyData = _serializers.serialize(emberFlexberryDummyCatalogMasterUpdate,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
