...
import 'package:backend/src/model/collection_of_catalog.dart';
...
import 'package:backend/src/model/ember_flexberry_dummy_catalog_create.dart';
import 'package:backend/src/model/ember_flexberry_dummy_catalog_master.dart';
import 'package:backend/src/model/ember_flexberry_dummy_catalog_update.dart';
...
class EmberFlexberryDummyCatalogsApi {
  final Dio _dio;

  final Serializers _serializers;

  const EmberFlexberryDummyCatalogsApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [CollectionOfCatalog] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CollectionOfCatalog>> emberFlexberryDummyCatalogsGet({
    int? dollarTop,
    int? dollarSkip,
    String? dollarSearch,
    String? dollarFilter,
    ...
    final _path = r'/EmberFlexberryDummyCatalogs';
    ...
    CollectionOfCatalog? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(CollectionOfCatalog),
            ) as CollectionOfCatalog;
    ...
    return Response<CollectionOfCatalog>(
      data: _responseData,
  ...
  ///
  /// Parameters:
  /// * [emberFlexberryDummyCatalogCreate] - New entity
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<EmberFlexberryDummyCatalog>> emberFlexberryDummyCatalogsPost({
    required EmberFlexberryDummyCatalogCreate emberFlexberryDummyCatalogCreate,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(EmberFlexberryDummyCatalogCreate);
      _bodyData = _serializers.serialize(emberFlexberryDummyCatalogCreate,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [EmberFlexberryDummyCatalogMaster] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<EmberFlexberryDummyCatalogMaster>>
    ...
    final _path = r'/EmberFlexberryDummyCatalogs({__PrimaryKey})/CatalogMaster'
        .replaceAll(
            '{' r'__PrimaryKey' '}',
    ...
    EmberFlexberryDummyCatalogMaster? _responseData;
    ...
    return Response<EmberFlexberryDummyCatalogMaster>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> emberFlexberryDummyCatalogsPrimaryKeyDelete({
    required String primaryKey,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/EmberFlexberryDummyCatalogs({__PrimaryKey})'.replaceAll(
        '{' r'__PrimaryKey' '}',
  ...
  /// Parameters:
  /// * [primaryKey] - key: __PrimaryKey
  /// * [emberFlexberryDummyCatalogUpdate] - New property values
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> emberFlexberryDummyCatalogsPrimaryKeyPatch({
    required String primaryKey,
    required EmberFlexberryDummyCatalogUpdate emberFlexberryDummyCatalogUpdate,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(EmberFlexberryDummyCatalogUpdate);
      _bodyData = _serializers.serialize(emberFlexberryDummyCatalogUpdate,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
