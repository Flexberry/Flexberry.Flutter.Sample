...
import 'package:backend/src/model/collection_of_child_level1.dart';
...
class EmberFlexberryDummyChildLevel1sApi {
  final Dio _dio;

  final Serializers _serializers;

  const EmberFlexberryDummyChildLevel1sApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [CollectionOfChildLevel1] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CollectionOfChildLevel1>> emberFlexberryDummyChildLevel1sGet({
    int? dollarTop,
    int? dollarSkip,
    String? dollarSearch,
    String? dollarFilter,
    ...
    final _path = r'/EmberFlexberryDummyChildLevel1s';
    ...
    CollectionOfChildLevel1? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(CollectionOfChildLevel1),
            ) as CollectionOfChildLevel1;
    ...
    return Response<CollectionOfChildLevel1>(
      data: _responseData,
  ...
  Future<Response<EmberFlexberryDummyApplicationUser>>
    ...
    final _path = r'/EmberFlexberryDummyChildLevel1s({__PrimaryKey})/Author'
        .replaceAll(
            '{' r'__PrimaryKey' '}',
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> emberFlexberryDummyChildLevel1sPrimaryKeyDelete({
    required String primaryKey,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/EmberFlexberryDummyChildLevel1s({__PrimaryKey})'
        .replaceAll(
            '{' r'__PrimaryKey' '}',
            encodeQueryParameter(
                    _serializers, primaryKey, const FullType(String))
  ...
  Future<Response<EmberFlexberryDummyApplicationUser>>
    ...
    final _path = r'/EmberFlexberryDummyChildLevel1s({__PrimaryKey})/Editor1'
        .replaceAll(
            '{' r'__PrimaryKey' '}',
            encodeQueryParameter(
                    _serializers, primaryKey, const FullType(String))
  ...
  Future<Response<CollectionOfSuggestionFile>>
    ...
    final _path = r'/EmberFlexberryDummyChildLevel1s({__PrimaryKey})/Files'
        .replaceAll(
            '{' r'__PrimaryKey' '}',
            encodeQueryParameter(
                    _serializers, primaryKey, const FullType(String))
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> emberFlexberryDummyChildLevel1sPrimaryKeyPatch({
    required String primaryKey,
  ...
  Future<Response<EmberFlexberryDummySuggestionType>>
    ...
    final _path = r'/EmberFlexberryDummyChildLevel1s({__PrimaryKey})/Type'
        .replaceAll(
            '{' r'__PrimaryKey' '}',
            encodeQueryParameter(
                    _serializers, primaryKey, const FullType(String))
  ...
  Future<Response<CollectionOfVote>>
    ...
    final _path = r'/EmberFlexberryDummyChildLevel1s({__PrimaryKey})/UserVotes'
        .replaceAll(
            '{' r'__PrimaryKey' '}',
            encodeQueryParameter(
                    _serializers, primaryKey, const FullType(String))
