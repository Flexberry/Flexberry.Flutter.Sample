...
import 'package:backend/src/model/ember_flexberry_dummy_comment_vote_update.dart';
import 'package:backend/src/model/error.dart';
import 'package:built_collection/built_collection.dart';

class EmberFlexberryDummyCommentVotesApi {
  final Dio _dio;

  final Serializers _serializers;

  const EmberFlexberryDummyCommentVotesApi(this._dio, this._serializers);
  ...
  Future<Response<CollectionOfCommentVote>> emberFlexberryDummyCommentVotesGet({
    int? dollarTop,
    int? dollarSkip,
    String? dollarSearch,
    String? dollarFilter,
    ...
    final _path = r'/EmberFlexberryDummyCommentVotes';
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> emberFlexberryDummyCommentVotesPrimaryKeyDelete({
    required String primaryKey,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/EmberFlexberryDummyCommentVotes({__PrimaryKey})'
        .replaceAll(
            '{' r'__PrimaryKey' '}',
            encodeQueryParameter(
                    _serializers, primaryKey, const FullType(String))
  ...
  /// Parameters:
  /// * [primaryKey] - key: __PrimaryKey
  /// * [emberFlexberryDummyCommentVoteUpdate] - New property values
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> emberFlexberryDummyCommentVotesPrimaryKeyPatch({
    required String primaryKey,
    required EmberFlexberryDummyCommentVoteUpdate
    ...
    try {
      const _type = FullType(EmberFlexberryDummyCommentVoteUpdate);
      _bodyData = _serializers.serialize(emberFlexberryDummyCommentVoteUpdate,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
