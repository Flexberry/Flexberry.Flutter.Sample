...
import 'package:backend/src/model/collection_of_departament.dart';
import 'package:backend/src/model/ember_flexberry_dummy_departament.dart';
import 'package:backend/src/model/ember_flexberry_dummy_departament_create.dart';
import 'package:backend/src/model/ember_flexberry_dummy_departament_update.dart';
...
class EmberFlexberryDummyDepartamentsApi {
  final Dio _dio;

  final Serializers _serializers;

  const EmberFlexberryDummyDepartamentsApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [CollectionOfDepartament] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CollectionOfDepartament>> emberFlexberryDummyDepartamentsGet({
    int? dollarTop,
    int? dollarSkip,
    String? dollarSearch,
    String? dollarFilter,
    ...
    final _path = r'/EmberFlexberryDummyDepartaments';
    ...
    CollectionOfDepartament? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(CollectionOfDepartament),
            ) as CollectionOfDepartament;
    ...
    return Response<CollectionOfDepartament>(
      data: _responseData,
  ...
  ///
  /// Parameters:
  /// * [emberFlexberryDummyDepartamentCreate] - New entity
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<EmberFlexberryDummyDepartament>>
    ...
    required EmberFlexberryDummyDepartamentCreate
    ...
    try {
      const _type = FullType(EmberFlexberryDummyDepartamentCreate);
      _bodyData = _serializers.serialize(emberFlexberryDummyDepartamentCreate,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> emberFlexberryDummyDepartamentsPrimaryKeyDelete({
    ...
    final _path = r'/EmberFlexberryDummyDepartaments({__PrimaryKey})'
        .replaceAll(
            '{' r'__PrimaryKey' '}',
  ...
  /// Parameters:
  /// * [primaryKey] - key: __PrimaryKey
  /// * [emberFlexberryDummyDepartamentUpdate] - New property values
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> emberFlexberryDummyDepartamentsPrimaryKeyPatch({
    required String primaryKey,
    required EmberFlexberryDummyDepartamentUpdate
    ...
    try {
      const _type = FullType(EmberFlexberryDummyDepartamentUpdate);
      _bodyData = _serializers.serialize(emberFlexberryDummyDepartamentUpdate,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
