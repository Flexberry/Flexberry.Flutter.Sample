...
import 'package:backend/src/model/ember_flexberry_dummy_detail_update.dart';
import 'package:backend/src/model/ember_flexberry_dummy_master.dart';
import 'package:backend/src/model/error.dart';
import 'package:built_collection/built_collection.dart';

class EmberFlexberryDummyDetailsApi {
  final Dio _dio;

  final Serializers _serializers;

  const EmberFlexberryDummyDetailsApi(this._dio, this._serializers);
  ...
  Future<Response<CollectionOfDetail>> emberFlexberryDummyDetailsGet({
    int? dollarTop,
    int? dollarSkip,
    String? dollarSearch,
    String? dollarFilter,
    ...
    final _path = r'/EmberFlexberryDummyDetails';
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<EmberFlexberryDummyDetail>> emberFlexberryDummyDetailsPost({
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> emberFlexberryDummyDetailsPrimaryKeyDelete({
    ...
    final _path = r'/EmberFlexberryDummyDetails({__PrimaryKey})'.replaceAll(
        '{' r'__PrimaryKey' '}',
  ...
  Future<Response<EmberFlexberryDummyDetail>>
    ...
    final _path = r'/EmberFlexberryDummyDetails({__PrimaryKey})/ParentDetail'
        .replaceAll(
            '{' r'__PrimaryKey' '}',
            encodeQueryParameter(
                    _serializers, primaryKey, const FullType(String))
  ...
  /// Parameters:
  /// * [primaryKey] - key: __PrimaryKey
  /// * [emberFlexberryDummyDetailUpdate] - New property values
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> emberFlexberryDummyDetailsPrimaryKeyPatch({
    required String primaryKey,
    required EmberFlexberryDummyDetailUpdate emberFlexberryDummyDetailUpdate,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(EmberFlexberryDummyDetailUpdate);
      _bodyData = _serializers.serialize(emberFlexberryDummyDetailUpdate,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
