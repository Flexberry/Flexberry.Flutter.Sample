...
import 'package:backend/src/model/collection_of_graduate_record.dart';
...
class EmberFlexberryDummyGraduateRecordsApi {
  final Dio _dio;

  final Serializers _serializers;

  const EmberFlexberryDummyGraduateRecordsApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [CollectionOfGraduateRecord] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CollectionOfGraduateRecord>>
    ...
    final _path = r'/EmberFlexberryDummyGraduateRecords';
    ...
    CollectionOfGraduateRecord? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(CollectionOfGraduateRecord),
            ) as CollectionOfGraduateRecord;
    ...
    return Response<CollectionOfGraduateRecord>(
      data: _responseData,
  ...
  ///
  /// Parameters:
  /// * [emberFlexberryDummyGraduateRecordCreate] - New entity
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [EmberFlexberryDummyGraduateRecord] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<EmberFlexberryDummyGraduateRecord>>
      emberFlexberryDummyGraduateRecordsPost({
    required EmberFlexberryDummyGraduateRecordCreate
    ...
    try {
      const _type = FullType(EmberFlexberryDummyGraduateRecordCreate);
    ...
    EmberFlexberryDummyGraduateRecord? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(EmberFlexberryDummyGraduateRecord),
            ) as EmberFlexberryDummyGraduateRecord;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<EmberFlexberryDummyGraduateRecord>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> emberFlexberryDummyGraduateRecordsPrimaryKeyDelete({
    ...
    final _path = r'/EmberFlexberryDummyGraduateRecords({__PrimaryKey})'
        .replaceAll(
            '{' r'__PrimaryKey' '}',
  ...
  /// Parameters:
  /// * [primaryKey] - key: __PrimaryKey
  /// * [emberFlexberryDummyGraduateRecordUpdate] - New property values
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> emberFlexberryDummyGraduateRecordsPrimaryKeyPatch({
    required String primaryKey,
    required EmberFlexberryDummyGraduateRecordUpdate
    ...
    try {
      const _type = FullType(EmberFlexberryDummyGraduateRecordUpdate);
      _bodyData = _serializers.serialize(
          emberFlexberryDummyGraduateRecordUpdate,
          specifiedType: _type);
    } catch (error, stackTrace) {
