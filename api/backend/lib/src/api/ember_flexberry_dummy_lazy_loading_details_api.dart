...
import 'package:backend/src/model/ember_flexberry_dummy_lazy_loading_detail_update.dart';
...
class EmberFlexberryDummyLazyLoadingDetailsApi {
  final Dio _dio;

  final Serializers _serializers;

  const EmberFlexberryDummyLazyLoadingDetailsApi(this._dio, this._serializers);
  ...
  Future<Response<CollectionOfLazyLoadingDetail>>
    ...
    final _path = r'/EmberFlexberryDummyLazyLoadingDetails';
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> emberFlexberryDummyLazyLoadingDetailsPrimaryKeyDelete({
    ...
    final _path = r'/EmberFlexberryDummyLazyLoadingDetails({__PrimaryKey})'
        .replaceAll(
            '{' r'__PrimaryKey' '}',
  ...
  /// Parameters:
  /// * [primaryKey] - key: __PrimaryKey
  /// * [emberFlexberryDummyLazyLoadingDetailUpdate] - New property values
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> emberFlexberryDummyLazyLoadingDetailsPrimaryKeyPatch({
    required String primaryKey,
    required EmberFlexberryDummyLazyLoadingDetailUpdate
    ...
    try {
      const _type = FullType(EmberFlexberryDummyLazyLoadingDetailUpdate);
      _bodyData = _serializers.serialize(
          emberFlexberryDummyLazyLoadingDetailUpdate,
          specifiedType: _type);
    } catch (error, stackTrace) {
