...
import 'package:backend/src/model/collection_of_lazy_loading_detail.dart';
import 'package:backend/src/model/collection_of_lazy_loading_master.dart';
import 'package:backend/src/model/ember_flexberry_dummy_lazy_loading_detail.dart';
import 'package:backend/src/model/ember_flexberry_dummy_lazy_loading_detail_create.dart';
import 'package:backend/src/model/ember_flexberry_dummy_lazy_loading_master.dart';
import 'package:backend/src/model/ember_flexberry_dummy_lazy_loading_master_create.dart';
import 'package:backend/src/model/ember_flexberry_dummy_lazy_loading_master_update.dart';
import 'package:backend/src/model/error.dart';
import 'package:built_collection/built_collection.dart';

class EmberFlexberryDummyLazyLoadingMastersApi {
  final Dio _dio;

  final Serializers _serializers;

  const EmberFlexberryDummyLazyLoadingMastersApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [EmberFlexberryDummyLazyLoadingMaster] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<EmberFlexberryDummyLazyLoadingMaster>>
    ...
    final _path =
        r'/EmberFlexberryDummyLazyLoadingDetails({__PrimaryKey})/LazyLoadingMaster'
            .replaceAll(
                '{' r'__PrimaryKey' '}',
    ...
    EmberFlexberryDummyLazyLoadingMaster? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType:
                  const FullType(EmberFlexberryDummyLazyLoadingMaster),
    ...
    return Response<EmberFlexberryDummyLazyLoadingMaster>(
      data: _responseData,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [CollectionOfLazyLoadingMaster] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CollectionOfLazyLoadingMaster>>
    ...
    final _path = r'/EmberFlexberryDummyLazyLoadingMasters';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    CollectionOfLazyLoadingMaster? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(CollectionOfLazyLoadingMaster),
            ) as CollectionOfLazyLoadingMaster;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<CollectionOfLazyLoadingMaster>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  ///
  /// Parameters:
  /// * [emberFlexberryDummyLazyLoadingMasterCreate] - New entity
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<EmberFlexberryDummyLazyLoadingMaster>>
    ...
    required EmberFlexberryDummyLazyLoadingMasterCreate
    ...
    try {
      const _type = FullType(EmberFlexberryDummyLazyLoadingMasterCreate);
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> emberFlexberryDummyLazyLoadingMastersPrimaryKeyDelete({
    required String primaryKey,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/EmberFlexberryDummyLazyLoadingMasters({__PrimaryKey})'
        .replaceAll(
            '{' r'__PrimaryKey' '}',
            encodeQueryParameter(
                    _serializers, primaryKey, const FullType(String))
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [CollectionOfLazyLoadingDetail] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CollectionOfLazyLoadingDetail>>
    ...
    final _path =
        r'/EmberFlexberryDummyLazyLoadingMasters({__PrimaryKey})/LazyLoadingDetail'
            .replaceAll(
                '{' r'__PrimaryKey' '}',
                encodeQueryParameter(
                        _serializers, primaryKey, const FullType(String))
    ...
    CollectionOfLazyLoadingDetail? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(CollectionOfLazyLoadingDetail),
            ) as CollectionOfLazyLoadingDetail;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<CollectionOfLazyLoadingDetail>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Parameters:
  /// * [primaryKey] - key: __PrimaryKey
  /// * [emberFlexberryDummyLazyLoadingDetailCreate] - New entity
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [EmberFlexberryDummyLazyLoadingDetail] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<EmberFlexberryDummyLazyLoadingDetail>>
      emberFlexberryDummyLazyLoadingMastersPrimaryKeyLazyLoadingDetailPost({
    required String primaryKey,
    required EmberFlexberryDummyLazyLoadingDetailCreate
    ...
    try {
      const _type = FullType(EmberFlexberryDummyLazyLoadingDetailCreate);
      _bodyData = _serializers.serialize(
          emberFlexberryDummyLazyLoadingDetailCreate,
          specifiedType: _type);
    } catch (error, stackTrace) {
    ...
    EmberFlexberryDummyLazyLoadingDetail? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType:
                  const FullType(EmberFlexberryDummyLazyLoadingDetail),
            ) as EmberFlexberryDummyLazyLoadingDetail;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<EmberFlexberryDummyLazyLoadingDetail>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Parameters:
  /// * [primaryKey] - key: __PrimaryKey
  /// * [emberFlexberryDummyLazyLoadingMasterUpdate] - New property values
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> emberFlexberryDummyLazyLoadingMastersPrimaryKeyPatch({
    required String primaryKey,
    required EmberFlexberryDummyLazyLoadingMasterUpdate
    ...
    try {
      const _type = FullType(EmberFlexberryDummyLazyLoadingMasterUpdate);
      _bodyData = _serializers.serialize(
          emberFlexberryDummyLazyLoadingMasterUpdate,
          specifiedType: _type);
    } catch (error, stackTrace) {
