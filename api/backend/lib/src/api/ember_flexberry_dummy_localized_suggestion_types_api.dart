...
import 'package:backend/src/model/ember_flexberry_dummy_localized_suggestion_type_update.dart';
...
class EmberFlexberryDummyLocalizedSuggestionTypesApi {
  final Dio _dio;

  final Serializers _serializers;

  const EmberFlexberryDummyLocalizedSuggestionTypesApi(
  ...
  Future<Response<CollectionOfLocalizedSuggestionType>>
    ...
    final _path = r'/EmberFlexberryDummyLocalizedSuggestionTypes';
  ...
  Future<Response<void>>
    ...
    final _path =
        r'/EmberFlexberryDummyLocalizedSuggestionTypes({__PrimaryKey})'
            .replaceAll(
                '{' r'__PrimaryKey' '}',
  ...
  /// Parameters:
  /// * [primaryKey] - key: __PrimaryKey
  /// * [emberFlexberryDummyLocalizedSuggestionTypeUpdate] - New property values
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<void>>
    ...
    required String primaryKey,
    required EmberFlexberryDummyLocalizedSuggestionTypeUpdate
    ...
    try {
      const _type = FullType(EmberFlexberryDummyLocalizedSuggestionTypeUpdate);
      _bodyData = _serializers.serialize(
          emberFlexberryDummyLocalizedSuggestionTypeUpdate,
          specifiedType: _type);
    } catch (error, stackTrace) {
