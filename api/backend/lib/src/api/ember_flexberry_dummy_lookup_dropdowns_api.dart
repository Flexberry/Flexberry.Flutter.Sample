...
import 'package:backend/src/model/collection_of_lookup_dropdown.dart';
import 'package:backend/src/model/ember_flexberry_dummy_lookup_dropdown.dart';
import 'package:backend/src/model/ember_flexberry_dummy_lookup_dropdown_create.dart';
import 'package:backend/src/model/ember_flexberry_dummy_lookup_dropdown_update.dart';
...
class EmberFlexberryDummyLookupDropdownsApi {
  final Dio _dio;

  final Serializers _serializers;

  const EmberFlexberryDummyLookupDropdownsApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [CollectionOfLookupDropdown] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CollectionOfLookupDropdown>>
    ...
    final _path = r'/EmberFlexberryDummyLookupDropdowns';
    ...
    CollectionOfLookupDropdown? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(CollectionOfLookupDropdown),
            ) as CollectionOfLookupDropdown;
    ...
    return Response<CollectionOfLookupDropdown>(
      data: _responseData,
  ...
  ///
  /// Parameters:
  /// * [emberFlexberryDummyLookupDropdownCreate] - New entity
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [EmberFlexberryDummyLookupDropdown] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<EmberFlexberryDummyLookupDropdown>>
      emberFlexberryDummyLookupDropdownsPost({
    required EmberFlexberryDummyLookupDropdownCreate
    ...
    try {
      const _type = FullType(EmberFlexberryDummyLookupDropdownCreate);
    ...
    EmberFlexberryDummyLookupDropdown? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(EmberFlexberryDummyLookupDropdown),
            ) as EmberFlexberryDummyLookupDropdown;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<EmberFlexberryDummyLookupDropdown>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> emberFlexberryDummyLookupDropdownsPrimaryKeyDelete({
    ...
    final _path = r'/EmberFlexberryDummyLookupDropdowns({__PrimaryKey})'
        .replaceAll(
            '{' r'__PrimaryKey' '}',
  ...
  /// Parameters:
  /// * [primaryKey] - key: __PrimaryKey
  /// * [emberFlexberryDummyLookupDropdownUpdate] - New property values
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> emberFlexberryDummyLookupDropdownsPrimaryKeyPatch({
    required String primaryKey,
    required EmberFlexberryDummyLookupDropdownUpdate
    ...
    try {
      const _type = FullType(EmberFlexberryDummyLookupDropdownUpdate);
      _bodyData = _serializers.serialize(
          emberFlexberryDummyLookupDropdownUpdate,
          specifiedType: _type);
    } catch (error, stackTrace) {
