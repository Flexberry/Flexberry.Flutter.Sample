...
import 'package:backend/src/model/collection_of_detail.dart';
import 'package:backend/src/model/collection_of_master.dart';
import 'package:backend/src/model/ember_flexberry_dummy_detail.dart';
import 'package:backend/src/model/ember_flexberry_dummy_detail_create.dart';
import 'package:backend/src/model/ember_flexberry_dummy_master.dart';
import 'package:backend/src/model/ember_flexberry_dummy_master_create.dart';
import 'package:backend/src/model/ember_flexberry_dummy_master_update.dart';
import 'package:backend/src/model/error.dart';
import 'package:built_collection/built_collection.dart';

class EmberFlexberryDummyMastersApi {
  final Dio _dio;

  final Serializers _serializers;

  const EmberFlexberryDummyMastersApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [EmberFlexberryDummyMaster] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<EmberFlexberryDummyMaster>>
    ...
    final _path = r'/EmberFlexberryDummyDetails({__PrimaryKey})/Master'
        .replaceAll(
            '{' r'__PrimaryKey' '}',
    ...
    EmberFlexberryDummyMaster? _responseData;
    ...
    return Response<EmberFlexberryDummyMaster>(
      data: _responseData,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [CollectionOfMaster] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CollectionOfMaster>> emberFlexberryDummyMastersGet({
    int? dollarTop,
    int? dollarSkip,
    String? dollarSearch,
    String? dollarFilter,
    ...
    final _path = r'/EmberFlexberryDummyMasters';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    CollectionOfMaster? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(CollectionOfMaster),
            ) as CollectionOfMaster;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<CollectionOfMaster>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  ///
  /// Parameters:
  /// * [emberFlexberryDummyMasterCreate] - New entity
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future] containing a [Response] with a [EmberFlexberryDummyMaster] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<EmberFlexberryDummyMaster>> emberFlexberryDummyMastersPost({
    required EmberFlexberryDummyMasterCreate emberFlexberryDummyMasterCreate,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(EmberFlexberryDummyMasterCreate);
      _bodyData = _serializers.serialize(emberFlexberryDummyMasterCreate,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> emberFlexberryDummyMastersPrimaryKeyDelete({
    required String primaryKey,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/EmberFlexberryDummyMasters({__PrimaryKey})'.replaceAll(
        '{' r'__PrimaryKey' '}',
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [CollectionOfDetail] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CollectionOfDetail>>
    ...
    final _path = r'/EmberFlexberryDummyMasters({__PrimaryKey})/Detail'
        .replaceAll(
            '{' r'__PrimaryKey' '}',
            encodeQueryParameter(
                    _serializers, primaryKey, const FullType(String))
    ...
    CollectionOfDetail? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(CollectionOfDetail),
            ) as CollectionOfDetail;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<CollectionOfDetail>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Parameters:
  /// * [primaryKey] - key: __PrimaryKey
  /// * [emberFlexberryDummyDetailCreate] - New entity
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [EmberFlexberryDummyDetail] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<EmberFlexberryDummyDetail>>
      emberFlexberryDummyMastersPrimaryKeyDetailPost({
    required String primaryKey,
    required EmberFlexberryDummyDetailCreate emberFlexberryDummyDetailCreate,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(EmberFlexberryDummyDetailCreate);
      _bodyData = _serializers.serialize(emberFlexberryDummyDetailCreate,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
    ...
    EmberFlexberryDummyDetail? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(EmberFlexberryDummyDetail),
    ...
    return Response<EmberFlexberryDummyDetail>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Parameters:
  /// * [primaryKey] - key: __PrimaryKey
  /// * [emberFlexberryDummyMasterUpdate] - New property values
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> emberFlexberryDummyMastersPrimaryKeyPatch({
    required String primaryKey,
    required EmberFlexberryDummyMasterUpdate emberFlexberryDummyMasterUpdate,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(EmberFlexberryDummyMasterUpdate);
      _bodyData = _serializers.serialize(emberFlexberryDummyMasterUpdate,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
