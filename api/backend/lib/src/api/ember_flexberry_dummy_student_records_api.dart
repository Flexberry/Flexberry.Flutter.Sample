...
import 'package:backend/src/model/collection_of_student_record.dart';
...
class EmberFlexberryDummyStudentRecordsApi {
  final Dio _dio;

  final Serializers _serializers;

  const EmberFlexberryDummyStudentRecordsApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [CollectionOfStudentRecord] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CollectionOfStudentRecord>>
    ...
    final _path = r'/EmberFlexberryDummyStudentRecords';
    ...
    CollectionOfStudentRecord? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(CollectionOfStudentRecord),
            ) as CollectionOfStudentRecord;
    ...
    return Response<CollectionOfStudentRecord>(
      data: _responseData,
  ...
  ///
  /// Parameters:
  /// * [emberFlexberryDummyStudentRecordCreate] - New entity
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [EmberFlexberryDummyStudentRecord] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<EmberFlexberryDummyStudentRecord>>
      emberFlexberryDummyStudentRecordsPost({
    required EmberFlexberryDummyStudentRecordCreate
    ...
    try {
      const _type = FullType(EmberFlexberryDummyStudentRecordCreate);
      _bodyData = _serializers.serialize(emberFlexberryDummyStudentRecordCreate,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
    ...
    EmberFlexberryDummyStudentRecord? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(EmberFlexberryDummyStudentRecord),
            ) as EmberFlexberryDummyStudentRecord;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<EmberFlexberryDummyStudentRecord>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> emberFlexberryDummyStudentRecordsPrimaryKeyDelete({
    ...
    final _path = r'/EmberFlexberryDummyStudentRecords({__PrimaryKey})'
        .replaceAll(
            '{' r'__PrimaryKey' '}',
  ...
  /// Parameters:
  /// * [primaryKey] - key: __PrimaryKey
  /// * [emberFlexberryDummyStudentRecordUpdate] - New property values
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> emberFlexberryDummyStudentRecordsPrimaryKeyPatch({
    required String primaryKey,
    required EmberFlexberryDummyStudentRecordUpdate
        emberFlexberryDummyStudentRecordUpdate,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(EmberFlexberryDummyStudentRecordUpdate);
      _bodyData = _serializers.serialize(emberFlexberryDummyStudentRecordUpdate,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
