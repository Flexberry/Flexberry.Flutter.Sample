...
import 'package:backend/src/model/collection_of_study_record.dart';
import 'package:backend/src/model/ember_flexberry_dummy_study_record.dart';
import 'package:backend/src/model/ember_flexberry_dummy_study_record_create.dart';
import 'package:backend/src/model/ember_flexberry_dummy_study_record_update.dart';
import 'package:backend/src/model/error.dart';
import 'package:built_collection/built_collection.dart';

class EmberFlexberryDummyStudyRecordsApi {
  final Dio _dio;

  final Serializers _serializers;

  const EmberFlexberryDummyStudyRecordsApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [CollectionOfStudyRecord] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CollectionOfStudyRecord>> emberFlexberryDummyStudyRecordsGet({
    int? dollarTop,
    int? dollarSkip,
    String? dollarSearch,
    String? dollarFilter,
    ...
    final _path = r'/EmberFlexberryDummyStudyRecords';
    ...
    CollectionOfStudyRecord? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(CollectionOfStudyRecord),
            ) as CollectionOfStudyRecord;
    ...
    return Response<CollectionOfStudyRecord>(
      data: _responseData,
  ...
  ///
  /// Parameters:
  /// * [emberFlexberryDummyStudyRecordCreate] - New entity
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [EmberFlexberryDummyStudyRecord] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<EmberFlexberryDummyStudyRecord>>
      emberFlexberryDummyStudyRecordsPost({
    EmberFlexberryDummyStudyRecordCreate? emberFlexberryDummyStudyRecordCreate,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(EmberFlexberryDummyStudyRecordCreate);
      _bodyData = _serializers.serialize(emberFlexberryDummyStudyRecordCreate,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
    ...
    EmberFlexberryDummyStudyRecord? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(EmberFlexberryDummyStudyRecord),
            ) as EmberFlexberryDummyStudyRecord;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<EmberFlexberryDummyStudyRecord>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> emberFlexberryDummyStudyRecordsPrimaryKeyDelete({
    ...
    final _path = r'/EmberFlexberryDummyStudyRecords({__PrimaryKey})'
        .replaceAll(
            '{' r'__PrimaryKey' '}',
  ...
  /// Parameters:
  /// * [primaryKey] - key: __PrimaryKey
  /// * [emberFlexberryDummyStudyRecordUpdate] - New property values
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> emberFlexberryDummyStudyRecordsPrimaryKeyPatch({
    required String primaryKey,
    EmberFlexberryDummyStudyRecordUpdate? emberFlexberryDummyStudyRecordUpdate,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(EmberFlexberryDummyStudyRecordUpdate);
      _bodyData = _serializers.serialize(emberFlexberryDummyStudyRecordUpdate,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
