...
import 'package:backend/src/model/collection_of_successor_social_network.dart';
...
class EmberFlexberryDummySuccessorSocialNetworksApi {
  final Dio _dio;

  final Serializers _serializers;

  const EmberFlexberryDummySuccessorSocialNetworksApi(
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [CollectionOfSuccessorSocialNetwork] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CollectionOfSuccessorSocialNetwork>>
    ...
    final _path = r'/EmberFlexberryDummySuccessorSocialNetworks';
    ...
    CollectionOfSuccessorSocialNetwork? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(CollectionOfSuccessorSocialNetwork),
            ) as CollectionOfSuccessorSocialNetwork;
    ...
    return Response<CollectionOfSuccessorSocialNetwork>(
      data: _responseData,
  ...
  ///
  /// Parameters:
  /// * [emberFlexberryDummySuccessorSocialNetworkCreate] - New entity
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [EmberFlexberryDummySuccessorSocialNetwork] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<EmberFlexberryDummySuccessorSocialNetwork>>
      emberFlexberryDummySuccessorSocialNetworksPost({
    required EmberFlexberryDummySuccessorSocialNetworkCreate
    ...
    try {
      const _type = FullType(EmberFlexberryDummySuccessorSocialNetworkCreate);
    ...
    EmberFlexberryDummySuccessorSocialNetwork? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType:
                  const FullType(EmberFlexberryDummySuccessorSocialNetwork),
            ) as EmberFlexberryDummySuccessorSocialNetwork;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<EmberFlexberryDummySuccessorSocialNetwork>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<void>>
    ...
    final _path = r'/EmberFlexberryDummySuccessorSocialNetworks({__PrimaryKey})'
        .replaceAll(
            '{' r'__PrimaryKey' '}',
  ...
  /// Parameters:
  /// * [primaryKey] - key: __PrimaryKey
  /// * [emberFlexberryDummySuccessorSocialNetworkUpdate] - New property values
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<void>>
    ...
    required String primaryKey,
    required EmberFlexberryDummySuccessorSocialNetworkUpdate
    ...
    try {
      const _type = FullType(EmberFlexberryDummySuccessorSocialNetworkUpdate);
      _bodyData = _serializers.serialize(
          emberFlexberryDummySuccessorSocialNetworkUpdate,
          specifiedType: _type);
    } catch (error, stackTrace) {
