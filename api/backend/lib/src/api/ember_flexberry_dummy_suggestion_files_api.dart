...
import 'package:backend/src/model/ember_flexberry_dummy_suggestion_file_update.dart';
import 'package:backend/src/model/error.dart';
import 'package:built_collection/built_collection.dart';

class EmberFlexberryDummySuggestionFilesApi {
  final Dio _dio;

  final Serializers _serializers;

  const EmberFlexberryDummySuggestionFilesApi(this._dio, this._serializers);
  ...
  Future<Response<CollectionOfSuggestionFile>>
    ...
    final _path = r'/EmberFlexberryDummySuggestionFiles';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> emberFlexberryDummySuggestionFilesPrimaryKeyDelete({
    required String primaryKey,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/EmberFlexberryDummySuggestionFiles({__PrimaryKey})'
        .replaceAll(
            '{' r'__PrimaryKey' '}',
            encodeQueryParameter(
                    _serializers, primaryKey, const FullType(String))
  ...
  /// Parameters:
  /// * [primaryKey] - key: __PrimaryKey
  /// * [emberFlexberryDummySuggestionFileUpdate] - New property values
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> emberFlexberryDummySuggestionFilesPrimaryKeyPatch({
    required String primaryKey,
    required EmberFlexberryDummySuggestionFileUpdate
    ...
    try {
      const _type = FullType(EmberFlexberryDummySuggestionFileUpdate);
      _bodyData = _serializers.serialize(
          emberFlexberryDummySuggestionFileUpdate,
          specifiedType: _type);
    } catch (error, stackTrace) {
