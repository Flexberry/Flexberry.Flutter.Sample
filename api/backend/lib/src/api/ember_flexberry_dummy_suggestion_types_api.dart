...
import 'package:backend/src/model/collection_of_localized_suggestion_type.dart';
import 'package:backend/src/model/collection_of_suggestion_type.dart';
import 'package:backend/src/model/ember_flexberry_dummy_localized_suggestion_type.dart';
import 'package:backend/src/model/ember_flexberry_dummy_localized_suggestion_type_create.dart';
import 'package:backend/src/model/ember_flexberry_dummy_suggestion_type.dart';
import 'package:backend/src/model/ember_flexberry_dummy_suggestion_type_create.dart';
import 'package:backend/src/model/ember_flexberry_dummy_suggestion_type_update.dart';
import 'package:backend/src/model/error.dart';
import 'package:built_collection/built_collection.dart';

class EmberFlexberryDummySuggestionTypesApi {
  final Dio _dio;

  final Serializers _serializers;

  const EmberFlexberryDummySuggestionTypesApi(this._dio, this._serializers);
  ...
  Future<Response<EmberFlexberryDummySuggestionType>>
    ...
    final _path =
        r'/EmberFlexberryDummyLocalizedSuggestionTypes({__PrimaryKey})/SuggestionType'
            .replaceAll(
                '{' r'__PrimaryKey' '}',
                encodeQueryParameter(
                        _serializers, primaryKey, const FullType(String))
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [CollectionOfSuggestionType] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CollectionOfSuggestionType>>
    ...
    final _path = r'/EmberFlexberryDummySuggestionTypes';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    CollectionOfSuggestionType? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(CollectionOfSuggestionType),
            ) as CollectionOfSuggestionType;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<CollectionOfSuggestionType>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  ///
  /// Parameters:
  /// * [emberFlexberryDummySuggestionTypeCreate] - New entity
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<EmberFlexberryDummySuggestionType>>
    ...
    required EmberFlexberryDummySuggestionTypeCreate
    ...
    try {
      const _type = FullType(EmberFlexberryDummySuggestionTypeCreate);
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> emberFlexberryDummySuggestionTypesPrimaryKeyDelete({
    required String primaryKey,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/EmberFlexberryDummySuggestionTypes({__PrimaryKey})'
        .replaceAll(
            '{' r'__PrimaryKey' '}',
            encodeQueryParameter(
                    _serializers, primaryKey, const FullType(String))
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [CollectionOfLocalizedSuggestionType] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CollectionOfLocalizedSuggestionType>>
    ...
    final _path =
        r'/EmberFlexberryDummySuggestionTypes({__PrimaryKey})/LocalizedTypes'
            .replaceAll(
                '{' r'__PrimaryKey' '}',
                encodeQueryParameter(
                        _serializers, primaryKey, const FullType(String))
    ...
    CollectionOfLocalizedSuggestionType? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType:
                  const FullType(CollectionOfLocalizedSuggestionType),
            ) as CollectionOfLocalizedSuggestionType;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<CollectionOfLocalizedSuggestionType>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Parameters:
  /// * [primaryKey] - key: __PrimaryKey
  /// * [emberFlexberryDummyLocalizedSuggestionTypeCreate] - New entity
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [EmberFlexberryDummyLocalizedSuggestionType] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<EmberFlexberryDummyLocalizedSuggestionType>>
      emberFlexberryDummySuggestionTypesPrimaryKeyLocalizedTypesPost({
    required String primaryKey,
    required EmberFlexberryDummyLocalizedSuggestionTypeCreate
    ...
    try {
      const _type = FullType(EmberFlexberryDummyLocalizedSuggestionTypeCreate);
      _bodyData = _serializers.serialize(
          emberFlexberryDummyLocalizedSuggestionTypeCreate,
          specifiedType: _type);
    } catch (error, stackTrace) {
    ...
    EmberFlexberryDummyLocalizedSuggestionType? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType:
                  const FullType(EmberFlexberryDummyLocalizedSuggestionType),
            ) as EmberFlexberryDummyLocalizedSuggestionType;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<EmberFlexberryDummyLocalizedSuggestionType>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<EmberFlexberryDummySuggestionType>>
    ...
    final _path = r'/EmberFlexberryDummySuggestionTypes({__PrimaryKey})/Parent'
        .replaceAll(
            '{' r'__PrimaryKey' '}',
            encodeQueryParameter(
                    _serializers, primaryKey, const FullType(String))
  ...
  /// Parameters:
  /// * [primaryKey] - key: __PrimaryKey
  /// * [emberFlexberryDummySuggestionTypeUpdate] - New property values
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> emberFlexberryDummySuggestionTypesPrimaryKeyPatch({
    required String primaryKey,
    required EmberFlexberryDummySuggestionTypeUpdate
    ...
    try {
      const _type = FullType(EmberFlexberryDummySuggestionTypeUpdate);
      _bodyData = _serializers.serialize(
          emberFlexberryDummySuggestionTypeUpdate,
          specifiedType: _type);
    } catch (error, stackTrace) {
