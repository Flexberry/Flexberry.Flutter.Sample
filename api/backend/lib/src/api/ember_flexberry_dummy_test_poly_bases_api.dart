...
import 'package:backend/src/model/collection_of_test_poly_base.dart';
import 'package:backend/src/model/ember_flexberry_dummy_test_poly_base.dart';
import 'package:backend/src/model/ember_flexberry_dummy_test_poly_base_create.dart';
import 'package:backend/src/model/ember_flexberry_dummy_test_poly_base_update.dart';
import 'package:backend/src/model/error.dart';
import 'package:built_collection/built_collection.dart';

class EmberFlexberryDummyTestPolyBasesApi {
  final Dio _dio;

  final Serializers _serializers;

  const EmberFlexberryDummyTestPolyBasesApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [CollectionOfTestPolyBase] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CollectionOfTestPolyBase>>
    ...
    final _path = r'/EmberFlexberryDummyTestPolyBases';
    ...
    CollectionOfTestPolyBase? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(CollectionOfTestPolyBase),
            ) as CollectionOfTestPolyBase;
    ...
    return Response<CollectionOfTestPolyBase>(
      data: _responseData,
  ...
  ///
  /// Parameters:
  /// * [emberFlexberryDummyTestPolyBaseCreate] - New entity
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [EmberFlexberryDummyTestPolyBase] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<EmberFlexberryDummyTestPolyBase>>
    ...
    try {
      const _type = FullType(EmberFlexberryDummyTestPolyBaseCreate);
      _bodyData = _serializers.serialize(emberFlexberryDummyTestPolyBaseCreate,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
    ...
    EmberFlexberryDummyTestPolyBase? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(EmberFlexberryDummyTestPolyBase),
    ...
    return Response<EmberFlexberryDummyTestPolyBase>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> emberFlexberryDummyTestPolyBasesPrimaryKeyDelete({
    ...
    final _path = r'/EmberFlexberryDummyTestPolyBases({__PrimaryKey})'
        .replaceAll(
            '{' r'__PrimaryKey' '}',
  ...
  /// Parameters:
  /// * [primaryKey] - key: __PrimaryKey
  /// * [emberFlexberryDummyTestPolyBaseUpdate] - New property values
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> emberFlexberryDummyTestPolyBasesPrimaryKeyPatch({
    required String primaryKey,
    ...
    try {
      const _type = FullType(EmberFlexberryDummyTestPolyBaseUpdate);
      _bodyData = _serializers.serialize(emberFlexberryDummyTestPolyBaseUpdate,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
  ...
  Future<Response<EmberFlexberryDummyTestPolyBase>>
    ...
    final _path = r'/EmberFlexberryDummyTestPolys({__PrimaryKey})/Relation'
        .replaceAll(
            '{' r'__PrimaryKey' '}',
            encodeQueryParameter(
                    _serializers, primaryKey, const FullType(String))
