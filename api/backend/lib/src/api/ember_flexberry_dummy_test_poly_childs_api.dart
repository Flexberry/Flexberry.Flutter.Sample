...
import 'package:backend/src/model/collection_of_test_poly_child.dart';
...
class EmberFlexberryDummyTestPolyChildsApi {
  final Dio _dio;

  final Serializers _serializers;

  const EmberFlexberryDummyTestPolyChildsApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [CollectionOfTestPolyChild] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CollectionOfTestPolyChild>>
    ...
    final _path = r'/EmberFlexberryDummyTestPolyChilds';
    ...
    CollectionOfTestPolyChild? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(CollectionOfTestPolyChild),
            ) as CollectionOfTestPolyChild;
    ...
    return Response<CollectionOfTestPolyChild>(
      data: _responseData,
  ...
  ///
  /// Parameters:
  /// * [emberFlexberryDummyTestPolyChildCreate] - New entity
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [EmberFlexberryDummyTestPolyChild] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<EmberFlexberryDummyTestPolyChild>>
      emberFlexberryDummyTestPolyChildsPost({
    required EmberFlexberryDummyTestPolyChildCreate
    ...
    try {
      const _type = FullType(EmberFlexberryDummyTestPolyChildCreate);
      _bodyData = _serializers.serialize(emberFlexberryDummyTestPolyChildCreate,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
    ...
    EmberFlexberryDummyTestPolyChild? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(EmberFlexberryDummyTestPolyChild),
            ) as EmberFlexberryDummyTestPolyChild;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<EmberFlexberryDummyTestPolyChild>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> emberFlexberryDummyTestPolyChildsPrimaryKeyDelete({
    ...
    final _path = r'/EmberFlexberryDummyTestPolyChilds({__PrimaryKey})'
        .replaceAll(
            '{' r'__PrimaryKey' '}',
  ...
  /// Parameters:
  /// * [primaryKey] - key: __PrimaryKey
  /// * [emberFlexberryDummyTestPolyChildUpdate] - New property values
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> emberFlexberryDummyTestPolyChildsPrimaryKeyPatch({
    required String primaryKey,
    required EmberFlexberryDummyTestPolyChildUpdate
    ...
    try {
      const _type = FullType(EmberFlexberryDummyTestPolyChildUpdate);
      _bodyData = _serializers.serialize(emberFlexberryDummyTestPolyChildUpdate,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
