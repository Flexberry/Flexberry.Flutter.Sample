...
import 'package:backend/src/model/ember_flexberry_dummy_vote_update.dart';
import 'package:backend/src/model/error.dart';
import 'package:built_collection/built_collection.dart';

class EmberFlexberryDummyVotesApi {
  final Dio _dio;

  final Serializers _serializers;

  const EmberFlexberryDummyVotesApi(this._dio, this._serializers);
  ...
  /// Returns a [Future] containing a [Response] with a [CollectionOfVote] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CollectionOfVote>> emberFlexberryDummyVotesGet({
    int? dollarTop,
    int? dollarSkip,
    String? dollarSearch,
    String? dollarFilter,
    ...
    final _path = r'/EmberFlexberryDummyVotes';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [EmberFlexberryDummyVote] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<EmberFlexberryDummyVote>> emberFlexberryDummyVotesPost({
    required EmberFlexberryDummyVoteCreate emberFlexberryDummyVoteCreate,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> emberFlexberryDummyVotesPrimaryKeyDelete({
    required String primaryKey,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/EmberFlexberryDummyVotes({__PrimaryKey})'.replaceAll(
        '{' r'__PrimaryKey' '}',
  ...
  /// Parameters:
  /// * [primaryKey] - key: __PrimaryKey
  /// * [emberFlexberryDummyVoteUpdate] - New property values
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> emberFlexberryDummyVotesPrimaryKeyPatch({
    required String primaryKey,
    required EmberFlexberryDummyVoteUpdate emberFlexberryDummyVoteUpdate,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(EmberFlexberryDummyVoteUpdate);
      _bodyData = _serializers.serialize(emberFlexberryDummyVoteUpdate,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
