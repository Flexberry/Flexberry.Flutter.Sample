...
import 'package:backend/src/model/collection_of_flexberry_adv_limit.dart';
import 'package:backend/src/model/error.dart';
import 'package:backend/src/model/flexberry_adv_limit.dart';
import 'package:backend/src/model/flexberry_adv_limit_create.dart';
import 'package:backend/src/model/flexberry_adv_limit_update.dart';
import 'package:built_collection/built_collection.dart';

class FlexberryAdvLimitsApi {
  final Dio _dio;

  final Serializers _serializers;

  const FlexberryAdvLimitsApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [CollectionOfFlexberryAdvLimit] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CollectionOfFlexberryAdvLimit>> flexberryAdvLimitsGet({
    int? dollarTop,
    int? dollarSkip,
    String? dollarSearch,
    String? dollarFilter,
    ...
    final _path = r'/FlexberryAdvLimits';
    ...
    CollectionOfFlexberryAdvLimit? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(CollectionOfFlexberryAdvLimit),
            ) as CollectionOfFlexberryAdvLimit;
    ...
    return Response<CollectionOfFlexberryAdvLimit>(
      data: _responseData,
  ...
  ///
  /// Parameters:
  /// * [flexberryAdvLimitCreate] - New entity
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [FlexberryAdvLimit] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<FlexberryAdvLimit>> flexberryAdvLimitsPost({
    required FlexberryAdvLimitCreate flexberryAdvLimitCreate,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(FlexberryAdvLimitCreate);
      _bodyData =
          _serializers.serialize(flexberryAdvLimitCreate, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
    ...
    FlexberryAdvLimit? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(FlexberryAdvLimit),
            ) as FlexberryAdvLimit;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<FlexberryAdvLimit>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> flexberryAdvLimitsPrimaryKeyDelete({
    ...
    final _path = r'/FlexberryAdvLimits({__PrimaryKey})'.replaceAll(
        '{' r'__PrimaryKey' '}',
  ...
  /// Returns a [Future] containing a [Response] with a [FlexberryAdvLimit] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<FlexberryAdvLimit>> flexberryAdvLimitsPrimaryKeyGet({
    required String primaryKey,
    BuiltSet<String>? dollarSelect,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// Parameters:
  /// * [primaryKey] - key: __PrimaryKey
  /// * [flexberryAdvLimitUpdate] - New property values
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> flexberryAdvLimitsPrimaryKeyPatch({
    required String primaryKey,
    required FlexberryAdvLimitUpdate flexberryAdvLimitUpdate,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(FlexberryAdvLimitUpdate);
      _bodyData =
          _serializers.serialize(flexberryAdvLimitUpdate, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
