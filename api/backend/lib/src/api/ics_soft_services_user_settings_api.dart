...
import 'package:backend/src/model/collection_of_user_setting.dart';
...
import 'package:backend/src/model/new_platform_flexberry_flexberry_user_setting_create.dart';
import 'package:backend/src/model/new_platform_flexberry_flexberry_user_setting_update.dart';
import 'package:built_collection/built_collection.dart';

class ICSSoftServicesUserSettingsApi {
  final Dio _dio;

  final Serializers _serializers;

  const ICSSoftServicesUserSettingsApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [CollectionOfUserSetting] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CollectionOfUserSetting>> iCSSoftServicesUserSettingsGet({
    int? dollarTop,
    int? dollarSkip,
    String? dollarSearch,
    String? dollarFilter,
    ...
    final _path = r'/ICSSoftServicesUserSettings';
    ...
    CollectionOfUserSetting? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(CollectionOfUserSetting),
            ) as CollectionOfUserSetting;
    ...
    return Response<CollectionOfUserSetting>(
      data: _responseData,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [NewPlatformFlexberryFlexberryUserSetting] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<NewPlatformFlexberryFlexberryUserSetting>>
      iCSSoftServicesUserSettingsPost({
    NewPlatformFlexberryFlexberryUserSettingCreate? body,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    NewPlatformFlexberryFlexberryUserSetting? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType:
                  const FullType(NewPlatformFlexberryFlexberryUserSetting),
            ) as NewPlatformFlexberryFlexberryUserSetting;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<NewPlatformFlexberryFlexberryUserSetting>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> iCSSoftServicesUserSettingsPrimaryKeyDelete({
    ...
    final _path = r'/ICSSoftServicesUserSettings({__PrimaryKey})'.replaceAll(
        '{' r'__PrimaryKey' '}',
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> iCSSoftServicesUserSettingsPrimaryKeyPatch({
    required String primaryKey,
    NewPlatformFlexberryFlexberryUserSettingUpdate? body,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
