...
import 'package:backend/src/model/collection_of_lock.dart';
...
class NewPlatformFlexberryServicesLocksApi {
  final Dio _dio;

  final Serializers _serializers;

  const NewPlatformFlexberryServicesLocksApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [CollectionOfLock] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CollectionOfLock>> newPlatformFlexberryServicesLocksGet({
    int? dollarTop,
    int? dollarSkip,
    String? dollarSearch,
    String? dollarFilter,
    ...
    final _path = r'/NewPlatformFlexberryServicesLocks';
    ...
    CollectionOfLock? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(CollectionOfLock),
            ) as CollectionOfLock;
    ...
    return Response<CollectionOfLock>(
      data: _responseData,
  ...
  ///
  /// Parameters:
  /// * [newPlatformFlexberryServicesLockCreate] - New entity
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<NewPlatformFlexberryServicesLock>>
    ...
    required NewPlatformFlexberryServicesLockCreate
    ...
    try {
      const _type = FullType(NewPlatformFlexberryServicesLockCreate);
      _bodyData = _serializers.serialize(newPlatformFlexberryServicesLockCreate,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> newPlatformFlexberryServicesLocksPrimaryKeyDelete({
    ...
    final _path = r'/NewPlatformFlexberryServicesLocks({__PrimaryKey})'
        .replaceAll(
            '{' r'__PrimaryKey' '}',
  ...
  /// Parameters:
  /// * [primaryKey] - key: __PrimaryKey
  /// * [newPlatformFlexberryServicesLockUpdate] - New property values
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> newPlatformFlexberryServicesLocksPrimaryKeyPatch({
    required String primaryKey,
    required NewPlatformFlexberryServicesLockUpdate
    ...
    try {
      const _type = FullType(NewPlatformFlexberryServicesLockUpdate);
      _bodyData = _serializers.serialize(newPlatformFlexberryServicesLockUpdate,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
