...
part of 'iis_caseberry_logging_objects_application_log.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$IISCaseberryLoggingObjectsApplicationLog
    extends IISCaseberryLoggingObjectsApplicationLog {
  @override
  ...
  factory _$IISCaseberryLoggingObjectsApplicationLog(
          [void Function(IISCaseberryLoggingObjectsApplicationLogBuilder)?
              updates]) =>
      (new IISCaseberryLoggingObjectsApplicationLogBuilder()..update(updates))
          ._build();

  _$IISCaseberryLoggingObjectsApplicationLog._(
      {this.category,
      this.eventId,
      this.priority,
      this.severity,
  ...
  @override
  IISCaseberryLoggingObjectsApplicationLog rebuild(
          void Function(IISCaseberryLoggingObjectsApplicationLogBuilder)
              updates) =>
      (toBuilder()..update(updates)).build();

  @override
  IISCaseberryLoggingObjectsApplicationLogBuilder toBuilder() =>
      new IISCaseberryLoggingObjectsApplicationLogBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is IISCaseberryLoggingObjectsApplicationLog &&
  ...
  String toString() {
    return (newBuiltValueToStringHelper(
            r'IISCaseberryLoggingObjectsApplicationLog')
...
class IISCaseberryLoggingObjectsApplicationLogBuilder
    implements
        Builder<IISCaseberryLoggingObjectsApplicationLog,
            IISCaseberryLoggingObjectsApplicationLogBuilder> {
  _$IISCaseberryLoggingObjectsApplicationLog? _$v;
  ...
  IISCaseberryLoggingObjectsApplicationLogBuilder() {
    IISCaseberryLoggingObjectsApplicationLog._defaults(this);
  }

  IISCaseberryLoggingObjectsApplicationLogBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(IISCaseberryLoggingObjectsApplicationLog other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$IISCaseberryLoggingObjectsApplicationLog;
  }

  @override
  void update(
      void Function(IISCaseberryLoggingObjectsApplicationLogBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  IISCaseberryLoggingObjectsApplicationLog build() => _build();

  _$IISCaseberryLoggingObjectsApplicationLog _build() {
    final _$result = _$v ??
        new _$IISCaseberryLoggingObjectsApplicationLog._(
            category: category,
            eventId: eventId,
            priority: priority,
            severity: severity,
