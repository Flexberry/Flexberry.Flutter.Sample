...
part of 'iis_caseberry_logging_objects_application_log_update.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$IISCaseberryLoggingObjectsApplicationLogUpdate
    extends IISCaseberryLoggingObjectsApplicationLogUpdate {
  @override
  ...
  factory _$IISCaseberryLoggingObjectsApplicationLogUpdate(
          [void Function(IISCaseberryLoggingObjectsApplicationLogUpdateBuilder)?
              updates]) =>
      (new IISCaseberryLoggingObjectsApplicationLogUpdateBuilder()
            ..update(updates))
          ._build();

  _$IISCaseberryLoggingObjectsApplicationLogUpdate._(
      {this.category,
      this.eventId,
      this.priority,
      this.severity,
  ...
  @override
  IISCaseberryLoggingObjectsApplicationLogUpdate rebuild(
          void Function(IISCaseberryLoggingObjectsApplicationLogUpdateBuilder)
              updates) =>
      (toBuilder()..update(updates)).build();

  @override
  IISCaseberryLoggingObjectsApplicationLogUpdateBuilder toBuilder() =>
      new IISCaseberryLoggingObjectsApplicationLogUpdateBuilder()
        ..replace(this);
  ...
  bool operator ==(Object other) {
    ...
    return other is IISCaseberryLoggingObjectsApplicationLogUpdate &&
  ...
  String toString() {
    return (newBuiltValueToStringHelper(
            r'IISCaseberryLoggingObjectsApplicationLogUpdate')
...
class IISCaseberryLoggingObjectsApplicationLogUpdateBuilder
    implements
        Builder<IISCaseberryLoggingObjectsApplicationLogUpdate,
            IISCaseberryLoggingObjectsApplicationLogUpdateBuilder> {
  _$IISCaseberryLoggingObjectsApplicationLogUpdate? _$v;
  ...
  IISCaseberryLoggingObjectsApplicationLogUpdateBuilder() {
    IISCaseberryLoggingObjectsApplicationLogUpdate._defaults(this);
  }

  IISCaseberryLoggingObjectsApplicationLogUpdateBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(IISCaseberryLoggingObjectsApplicationLogUpdate other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$IISCaseberryLoggingObjectsApplicationLogUpdate;
  }
  ...
  @override
  IISCaseberryLoggingObjectsApplicationLogUpdate build() => _build();

  _$IISCaseberryLoggingObjectsApplicationLogUpdate _build() {
    final _$result = _$v ??
        new _$IISCaseberryLoggingObjectsApplicationLogUpdate._(
            category: category,
            eventId: eventId,
            priority: priority,
            severity: severity,
